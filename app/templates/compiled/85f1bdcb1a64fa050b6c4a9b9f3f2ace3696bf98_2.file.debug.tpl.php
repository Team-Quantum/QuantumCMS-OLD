<?php /* Smarty version 3.1.28-dev/26, created on 2015-07-08 13:03:46
         compiled from "/home/vagrant/Code/QuantumCMS/vendor/smarty/smarty/libs/debug.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:885738587559d1fb2bad103_29812059%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85f1bdcb1a64fa050b6c4a9b9f3f2ace3696bf98' => 
    array (
      0 => '/home/vagrant/Code/QuantumCMS/vendor/smarty/smarty/libs/debug.tpl',
      1 => 1436357489,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '885738587559d1fb2bad103_29812059',
  'variables' => 
  array (
    'template_name' => 0,
    'template_data' => 0,
  ...
  'unifunc' => 'content_559d1fb2d07c33_15175497',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_559d1fb2d07c33_15175497')) {
function content_559d1fb2d07c33_15175497 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_debug_print_var')) require_once '/home/vagrant/Code/QuantumCMS/vendor/smarty/smarty/libs/plugins/modifier.debug_print_var.php';

$_smarty_tpl->properties['nocache_hash'] = '885738587559d1fb2bad103_29812059';
...
if (!empty($_smarty_tpl->tpl_vars['template_data']->value)) {?>Total Time <?php echo htmlspecialchars(sprintf("%.5f",$_smarty_tpl->tpl_vars['execution_time']->value), ENT_QUOTES, 'UTF-8');
    ...
    <?php if (!empty($_smarty_tpl->tpl_vars['template_data']->value)) {?>
        ...
        <div>
            <?php
$foreach_0_template_sav['s_item'] = isset($_smarty_tpl->tpl_vars['template']) ? $_smarty_tpl->tpl_vars['template'] : false;
...
$foreach_0_template_sav['item'] = $_smarty_tpl->tpl_vars['template'];
?>
                ...
                <br>
            <?php
$_smarty_tpl->tpl_vars['template'] = $foreach_0_template_sav['item'];
}
if ($foreach_0_template_sav['s_item']) {
$_smarty_tpl->tpl_vars['template'] = $foreach_0_template_sav['s_item'];
}
?>
        </div>
    <?php }?>
    ...
    <table id="table_assigned_vars">
        <?php
$foreach_1_vars_sav['s_item'] = isset($_smarty_tpl->tpl_vars['vars']) ? $_smarty_tpl->tpl_vars['vars'] : false;
...
$foreach_1_vars_sav['item'] = $_smarty_tpl->tpl_vars['vars'];
?>
 ...
 <?php }?></td>
         <?php
$_smarty_tpl->tpl_vars['vars'] = $foreach_1_vars_sav['item'];
}
if ($foreach_1_vars_sav['s_item']) {
$_smarty_tpl->tpl_vars['vars'] = $foreach_1_vars_sav['s_item'];
}
?>
    </table>
    ...
    <table id="table_config_vars">
        <?php
$foreach_2_vars_sav['s_item'] = isset($_smarty_tpl->tpl_vars['vars']) ? $_smarty_tpl->tpl_vars['vars'] : false;
...
$_smarty_tpl->tpl_vars['vars']->_loop = true;
$_smarty_tpl->tpl_vars['vars']->iteration++;
$foreach_2_vars_sav['item'] = $_smarty_tpl->tpl_vars['vars'];
?>
            <tr class="<?php if ($_smarty_tpl->tpl_vars['vars']->iteration%2 == 0) {?>odd<?php } else { ?>even<?php }?>">
                <td><h3><font color=blue>#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vars']->key, ENT_QUOTES, 'UTF-8');?>
#</font></h3>
        ...
        <?php
$_smarty_tpl->tpl_vars['vars'] = $foreach_2_vars_sav['item'];
}
if ($foreach_2_vars_sav['s_item']) {
$_smarty_tpl->tpl_vars['vars'] = $foreach_2_vars_sav['s_item'];
}
?>
